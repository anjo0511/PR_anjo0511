...
- Do you got the skills to make a web interface?
...
- Years 2018 to 2021
- What the processed data looked like (title, artist, albumname): 
...
- One can as well group some elements in the so called module to create a 
...
- The learning curve is not as big if you know R

- Modularize applications are greate but one need to choose your battles

- Recomend using shiny to share analysis results
